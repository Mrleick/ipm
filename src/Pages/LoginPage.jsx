...
const main = async () => {
 ...
 const clientId = "4a84ce2cc21c4b7da807f69c2279cb07";
 const redirectUri = "http://localhost:5174/Login";
 const scope = "user-read-private user-read-email user-library-read user-read-playback-state user-modify-playback-state user-read-currently-playing streaming user-read-playback-position ";
        ...
        <section>
          <form className="w-full space-y-8 dark:bg-primarycolor dark:text-white">
            ...
            <div className="flex flex-col items-center mt-8">
              ...
              <button className="p-4 aspect-square rounded-full bg-green-800" onClick={main}>
