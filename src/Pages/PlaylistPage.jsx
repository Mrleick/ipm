...
const PlaylistPage = () => {
  ...
  return (
    <>
      <section className="pb-20 ease-in duration-300 bg-wave bg-cover dark:bg-secondary-color dark:text-white min-h-96">
        <Header
          className="px-6 "
          buttonClass=""
          showBackButton={true}
      ...
      <main className="px-6 ease-in duration-300 pb-24 pb-20bg dark:bg-secondary-color dark:text-white">
        <Heading
          level="2"
